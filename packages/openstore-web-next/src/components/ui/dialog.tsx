...
const DialogOverlay = React.forwardRef<
  any, //React.ElementRef<typeof DialogPrimitive.Overlay>,
...
const DialogContent = React.forwardRef<
  any, //React.ElementRef<typeof DialogPrimitive.Content>,
...
const DialogTitle = React.forwardRef<
  any, //React.ElementRef<typeof DialogPrimitive.Title>,
...
const DialogDescription = React.forwardRef<
  any, //React.ElementRef<typeof DialogPrimitive.Description>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-neutral-500 dark:text-neutral-400", className, props.class)}
    {...props}
  />
))
